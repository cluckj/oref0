...
do 
    ...
    query="find%5Bdate%5D%5B%24gte%5D=$(to_epochtime "$i +6 hours" |nonl; echo 000)&find%5Bdate%5D%5B%24lte%5D=$(to_epochtime "$i +30 hours" |nonl; echo 000)&count=1000"
    ...
    query="find%5Bcreated_at%5D%5B%24gte%5D=`date --date="$i -18 hours" -Iminutes`&find%5Bcreated_at%5D%5B%24lte%5D=`date --date="$i +44 hours" -Iminutes`"
